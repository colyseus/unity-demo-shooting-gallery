...
namespace Colyseus.Schema
{
    ...
    public class ColyseusDecoder
    {
        ...
        /// <param name="it">The iterator who's <see cref="CSAIterator.Offset" /> will be used to Decode the data</param>
        /// <returns>A decoded <see cref="object" /> that has been decoded with a <paramref name="type" /> specified method</returns>
        public object DecodePrimitiveType(string type, byte[] bytes, CSAIterator it)
        {
            if (type == "string")
            {
        ...
        public float DecodeNumber(byte[] bytes, CSAIterator it)
        {
        ...
        public int DecodeInt8(byte[] bytes, CSAIterator it)
        {
        ...
        public uint DecodeUint8(byte[] bytes, CSAIterator it)
        {
        ...
        public short DecodeInt16(byte[] bytes, CSAIterator it)
        {
        ...
        public ushort DecodeUint16(byte[] bytes, CSAIterator it)
        {
        ...
        public int DecodeInt32(byte[] bytes, CSAIterator it)
        {
        ...
        public uint DecodeUint32(byte[] bytes, CSAIterator it)
        {
        ...
        public float DecodeFloat32(byte[] bytes, CSAIterator it)
        {
        ...
        public double DecodeFloat64(byte[] bytes, CSAIterator it)
        {
        ...
        public long DecodeInt64(byte[] bytes, CSAIterator it)
        {
        ...
        public ulong DecodeUint64(byte[] bytes, CSAIterator it)
        {
        ...
        public bool DecodeBoolean(byte[] bytes, CSAIterator it)
        {
        ...
        public string DecodeString(byte[] bytes, CSAIterator it)
        {
        ...
        /// <param name="it">The iterator who's <see cref="CSAIterator.Offset" /> will be used to Decode the data</param>
        /// <returns>
        ///     True if the current <see cref="CSAIterator.Offset" /> works with this array of <paramref name="bytes" />, false
        ///     otherwise
        /// </returns>
        public bool SwitchStructureCheck(byte[] bytes, CSAIterator it)
        {
            return bytes[it.Offset] == (byte) CSASPEC.SWITCH_TO_STRUCTURE;
        }
        ...
        public bool NumberCheck(byte[] bytes, CSAIterator it)
        {
            byte prefix = bytes[it.Offset];

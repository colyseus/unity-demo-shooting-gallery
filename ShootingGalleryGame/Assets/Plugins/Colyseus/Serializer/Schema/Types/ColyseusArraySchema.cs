...
{
    /// <summary>
    ///     A <see cref="ColyseusSchema" /> array of <typeparamref name="T" /> type objects
    /// </summary>
    /// <typeparam name="T">The type of object in this array</typeparam>
    public class ColyseusArraySchema<T> : IColyseusSchemaCollection
    {
        /// <summary>
        ...
        /// <summary>
        ///     The contents of the <see cref="ColyseusArraySchema{T}" />
        /// </summary>
        public Dictionary<int, T> items;

        public ColyseusArraySchema()
        {
            items = new Dictionary<int, T>();
        }

        public ColyseusArraySchema(Dictionary<int, T> items = null)
        {
        ...
        /// </summary>
        /// <param name="index">Unused, only here to satisfy <see cref="IColyseusRef" /> parameters</param>
        ...
        /// <summary>
        ///     Get an item out of the <see cref="ColyseusArraySchema{T}" /> by it's index
        /// </summary>
        ...
        /// <summary>
        ///     Clone this <see cref="ColyseusArraySchema{T}" />
        /// </summary>
        /// <returns>A copy of this <see cref="ColyseusArraySchema{T}" /></returns>
        public IColyseusSchemaCollection Clone()
        {
            ColyseusArraySchema<T> clone = new ColyseusArraySchema<T>(items)
            {
                OnAdd = OnAdd,
                OnChange = OnChange,
                OnRemove = OnRemove
        ...
        /// <summary>
        ///     Determine what type of item this <see cref="ColyseusArraySchema{T}" /> contains
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        ///     Determine if this <see cref="ColyseusArraySchema{T}" /> contains <paramref name="key" />
        /// </summary>
        ...
        /// <summary>
        ///     Getter/Setter of the <see cref="CSAType.ChildPrimitiveType" /> that this <see cref="ColyseusArraySchema{T}" />
        ///     contains
        /// </summary>
        public string ChildPrimitiveType { get; set; }

        /// <summary>
        ///     Getter for the amount of <see cref="items" /> in this <see cref="ColyseusArraySchema{T}" />
        /// </summary>
        public int Count
        {
        ...
        /// <summary>
        ///     Getter function to get all the <see cref="items" /> in this <see cref="ColyseusArraySchema{T}" />
        /// </summary>
        /// <returns>
        ///     <see cref="items" />
        /// </returns>
        ...
        /// </summary>
        /// <param name="items">
        ///     The items to pass to the <see cref="ColyseusArraySchema{T}" />. Will be cast to Dictionary{int,
        ///     <typeparamref name="T" />}
        /// </param>
        ...
        public void TriggerAll()
        {
            ...
            {
                OnAdd.Invoke(items[i], i);
            }
        }

        /// <summary>
        ///     Clone the Event Handlers from another <see cref="IColyseusRef" /> into this <see cref="ColyseusArraySchema{T}" />
        /// </summary>
        ...
        {
            OnAdd = ((ColyseusArraySchema<T>) previousInstance).OnAdd;
            OnChange = ((ColyseusArraySchema<T>) previousInstance).OnChange;
            OnRemove = ((ColyseusArraySchema<T>) previousInstance).OnRemove;
        }
        ...
        /// <summary>
        ///     Event that is invoked when something is added to the <see cref="ColyseusArraySchema{T}" />
        /// </summary>
        public event CSAKeyValueEventHandler<T, int> OnAdd;

        /// <summary>
        ///     Event that is invoked when something is changed in the <see cref="ColyseusArraySchema{T}" />
        /// </summary>
        public event CSAKeyValueEventHandler<T, int> OnChange;

        /// <summary>
        ///     Event that is invoked when something is removed from the <see cref="ColyseusArraySchema{T}" />
        /// </summary>
        public event CSAKeyValueEventHandler<T, int> OnRemove;

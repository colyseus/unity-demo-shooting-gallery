...
namespace Colyseus
{
    ...
    public class ColyseusClient
    {
        ...
        /// <summary>
        ///     Reference to the client's <see cref="ColyseusAuth" />
        /// </summary>
        public ColyseusAuth colyseusAuth;
        ...
        public ColyseusClient(string endpoint)
        {
            ...
            colyseusAuth = new ColyseusAuth(Endpoint.Uri);
        }
            ...
            Dictionary<string, object> options, Dictionary<string, string> headers)
        {
            ...
            if (colyseusAuth.HasToken)
            {
                options.Add("token", colyseusAuth.Token);
            }

...
{
    /// <summary>
    ///     Utility class for getting lists of <see cref="CSAPatchObject" /> and other related functionality
    /// </summary>
    public class ColyseusCompare
    {
        ...
        /// <returns>
        ///     An array of type <see cref="CSAPatchObject" /> representing the difference from <paramref name="tree1" /> to
        ///     <paramref name="tree2" />
        /// </returns>
        public static CSAPatchObject[] GetPatchList(IndexedDictionary<string, object> tree1,
            IndexedDictionary<string, object> tree2)
        {
            List<CSAPatchObject> patches = new List<CSAPatchObject>();
        ...
        /// </summary>
        protected static void Generate(List<object> mirror, List<object> obj, List<CSAPatchObject> patches,
            List<string> path)
        {
        ...
        protected static void Generate(IndexedDictionary<string, object> mirror, IndexedDictionary<string, object> obj,
            List<CSAPatchObject> patches, List<string> path)
        {
                ...
                )
                {
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            patches.Add(new CSAPatchObject
                            {
                                operation = "replace",
